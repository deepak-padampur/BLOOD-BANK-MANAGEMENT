...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2019 at 07:45 PM
...
INSERT INTO `admin` (`email`, `username`, `pass`) VALUES
('', '', ''),
('deepaknit028@gmail.com', 'deepak', '118209'),
('deepaknit028@gmail.com', 'deepak', '118209');
...
INSERT INTO `files` (`id`, `user_id`, `file`, `status`) VALUES
(1, 24, '5cb2f75a66ae33.43949069.png', 'yes'),
(2, 25, '5cb305e42a7460.67231219.jpg', 'yes'),
(3, 27, '5cb368685931e5.00969316.png', 'yes');
...
INSERT INTO `referal` (`id`, `sender`, `referal`, `email`, `attach`) VALUES
(18, 'DEEPAK SUNA', 'PRIYAMBADA', 'deepaksuna4290@gmail.com', '5cb2e802355b46.72585412.jpg'),
(19, 'DEEPAK SUNA', 'deepak028', 'deepaksuna4290@gmail.com', '5cb2e89f02d7a6.38133092.jpg'),
(20, 'PRIYAMBADA', 'shoaib', '2017ugcs026@gmail.com', '5cb33ec32e3001.69213617.pdf'),
(21, 'PRIYAMBADA', 'hvdc', '2017ugcs026@nitjsr.ac.in', '5cb33f1cc42900.27219011.png'),
(22, 'Vikash', 'DEEPAK SUNA', 'deepaksuna4290@gmail.com', '5cb34f5770e9b8.03166526.png'),
(23, 'asad', 'MAYANK', 'itsaprogrammer@gmail.com', '5cb368031f5bb9.99809202.png'),
(24, 'asad', 'YASH', 'yashwantakashlal@gmail.com', '5cb36c4851bb54.64705820.png');
...
INSERT INTO `stock` (`id`, `bloodgroup`, `available`) VALUES
(1, 'A+', 50),
(2, 'A-', 10),
(3, 'B+', 39),
(4, 'B-', 11),
...
CREATE TABLE `users` (
  ...
  `user_bg` varchar(10) NOT NULL,
  `token` varchar(100) NOT NULL,
  `tokenExpire` datetime(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users` (`user_id`, `user_name`, `img`, `user_username`, `user_pwd`, `user_email`, `user_contact`, `user_state`, `user_city`, `user_dob`, `user_gender`, `user_bg`, `token`, `tokenExpire`) VALUES
(24, 'DEEPAK SUNA', '5cb1a281cad5d4.35987818.jpg', 'deepak', '$2y$10$JewLP14ivGHqE8.vJmLZZ.VvcdzL8B2.b2dGSF58PDUOMjDaaDP6S', 'deepaknit028@gmail.com', '9304670287', 'JHARKHAND', 'JAMSHEDPUR', '1998-08-18', 'Male', 'B+', 'oed2l1e6nv', '2019-04-14 19:37:47.000000'),
(25, 'PRIYAMBADA', '5cb1a343175eb4.16347238.jpg', 'arti', '$2y$10$SLAtWBBMRnTzcnkPY2fUReqI70kngBuCVc.d6vzV9EPdI3X.Zjcwa', 'priyambada1212@gmail.com', '7062749093', 'ODISHA', 'PADAMPUR', '1995-12-16', 'Female', 'O+', '', '0000-00-00 00:00:00.000000'),
(26, 'Vikash', '5cb1c0bb3c9f66.10239651.png', 'vikash', '$2y$10$aYfWvIlQHmeqe33W./WYuuv3LykWQGSMd5chzGj4YYrZYcOv4II6e', 'vikash@gmail.com', '9958024123', 'BIHAR', 'GAYA', '2000-10-24', 'Male', 'O+', '', '0000-00-00 00:00:00.000000'),
(27, 'asad', '5cb367aa5830f4.06375367.jpg', 'dee', '$2y$10$ONSdOp8b15NjTO8wxmxZXu23.PaS1F85mWBwYaLEOv9CYgsGZBd.e', '2017ugcs043@gmail.com', '1234567890', 'JHARKHAND', 'JAMDHEDPUR', '2019-04-10', 'Male', 'A-', '', '0000-00-00 00:00:00.000000'),
(28, 'Satyam KUMAR', '5cb36d8ed4b455.24922142.png', 'satyam', '$2y$10$OnN3KjBIjPOYCe8Es/Z.JuAtM9lkvRZ86uN0MzpZnVpHlaA6/EhsK', 'test@gmail.com', '4355556378', 'ODISHA', 'ddsfs', '1999-06-07', 'Male', 'B+', '', '0000-00-00 00:00:00.000000');
