              ...
              <form action="includes/login.inc.php" method="POST">
                    ...
                    <img src="img/user.jpg" alt="" class="user">
                            <div class="text-box">
                                ...
                                <input type="text" placeholder="Username/e-mail" name="uname" value="" required>
                            </div>
                            ...
                            <div class="text-box">
                              ...
                              <a href="setting.php">Forgot Password &rarr;</a><br><br>
                              <a href="register.php">go to registration page &rarr;</a><br><br>
                              <input type="submit" class="button btn"onclick="myFunction()" name="login" value="login &rarr;">
                        </div>
